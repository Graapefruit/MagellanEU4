...
class DisplayManager():
    def __init__(self, x=1350, y=986):
        ...
        self.onCullDuplicateProvinceFiles = doNothing
    ...
    def createMenubar(self):
        ...
        self.createToolMenuCommand(self.otherToolsMenu, "Cull Duplicate Province Files", "This tool will iterate through every province/history file in your mod, and automatically cull any duplicates.\n In the case of multiple files sharing the same id, the files with the name matching the province names will automatically be chosen over the alternative.\nIf neither file has the province's name, the user will be prompted to choose which file to delete", (lambda : self.onCullDuplicateProvinceFiles()))
